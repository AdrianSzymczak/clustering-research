...
==================== results.txt ========================
The file is obtained directly by the search engine API and characters are coded using UTF8 (a variable-length character encoding for Unicode).
e.g. é  195 169 codifies the small letter e with acute accent.
